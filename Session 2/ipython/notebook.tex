...
\subsection{Making the request}\label{making-the-request}
...
\end{Verbatim}
    ...
    \subsubsection{Get the '/robots.txt' file
...
\end{Verbatim}
    ...
    \subsubsection{Get the HTML content from the
...
\end{Verbatim}
    ...
    \subsection{Scraping websites}\label{scraping-websites}
...
a scraper parses it to find the needle in the haystack.
    ...
    \subsubsection{BeautifulSoup Module}\label{beautifulsoup-module}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{import} \PY{n+nn}{requests}
        ...
        \PY{k}{if} \PY{n}{response}\PY{o}{.}\PY{n}{status\PYZus{}code} \PY{o}{==} \PY{l+m+mi}{200}\PY{p}{:}
            ...
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{soup}\PY{o}{.}\PY{n}{prettify}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{import} \PY{n+nn}{requests}
        ...
        \PY{k}{def} \PY{n+nf}{main}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{ret\PYZus{}soup} \PY{o}{=} \PY{n}{scrapecontent}\PY{p}{(}\PY{n}{scrape\PYZus{}url}\PY{p}{)}
            \PY{k}{if} \PY{n}{ret\PYZus{}soup}\PY{p}{:}
                \PY{k}{for} \PY{n}{rev\PYZus{}data} \PY{o+ow}{in} \PY{n}{ret\PYZus{}soup}\PY{o}{.}\PY{n}{find\PYZus{}all}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{div}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{class\PYZus{}}\PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{review\PYZhy{}container}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
